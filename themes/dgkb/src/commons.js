...
require('./fonts/Gilroy-ExtraBold.eot');
require('./fonts/Gilroy-ExtraBold.woff');
require('./fonts/Gilroy-ExtraBold.ttf');
require('./fonts/Gilroy-Light.eot');
require('./fonts/Gilroy-Light.woff');
...
require('./images/icons/search.png');
require('./images/icons/glasses.png');
require('./images/icons/comment.png');
require('./images/icons/more.png');
